...
Superwire is a declarative DSL for building AI-agent workflows. A `.wire` file describes the inputs a workflow accepts, the secrets it needs, the model provider it uses, the agents that should run, and the final structured output.
