...
The content expression accepts references (`agent.summarizer`, `dynamic.data`), string literals (`"manual content"`), number literals (`132`), and object literals (`{ value: "object content" }`).
