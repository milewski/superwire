...
impl ProviderEntry {
    ...
    pub fn is_reachable(&self) -> bool {
        ...
        addrs
            .into_iter()
            .any(|addr| std::net::TcpStream::connect_timeout(&addr, std::time::Duration::from_millis(200)).is_ok())
    }
...
fn extract_host_port(api_base: &str) -> Option<String> {
    let trimmed = api_base.trim_start_matches("https://").trim_start_matches("http://");
