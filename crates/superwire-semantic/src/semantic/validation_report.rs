...
use superwire_types::ast::{ReferenceKeyword, SourceSpan};
...
impl ValidationReport {
    ...
    pub fn push_issue_with_span(&mut self, issue: ValidationIssue, span: Option<SourceSpan>) {
