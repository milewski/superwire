...
use superwire_types::ast::{Reference, ReferenceAccess, ReferenceKeyword, ReferenceRoot, SourceSpan};
...
trait ReferenceResolutionExt {
    fn resolve_with<'semantic>(
        &self,
...
impl ReferenceResolutionExt for Reference {
    fn resolve_with<'semantic>(
        &self,
        reference_resolver: ReferenceResolver<'semantic>,
        resolution_scope: &ReferenceResolutionScope,
...
mod tests {
    ...
    use superwire_types::ast::{ReferenceAccess, ReferenceRoot};
