...
pub(crate) trait ExpressionTypeInferenceExt {
...
pub trait TypeExpressionInferenceExt {
    fn infer_agent_output_type<HashBuilder: std::hash::BuildHasher>(
        &self,
        type_inference_context: &TypeInferenceContext,
...
impl TypeExpressionInferenceExt for TypeExpression {
    fn infer_agent_output_type<HashBuilder: std::hash::BuildHasher>(
        &self,
        type_inference_context: &TypeInferenceContext,
        named_schema_types: &HashMap<String, TypeExpression, HashBuilder>,
...
trait AssetTypeInferenceExt {
    fn infer_type(&self, type_inference_context: &TypeInferenceContext, context: &str) -> Result<WorkflowType, WorkflowSemanticError>;
}

impl AssetTypeInferenceExt for Asset {
    fn infer_type(&self, type_inference_context: &TypeInferenceContext, context: &str) -> Result<WorkflowType, WorkflowSemanticError> {
...
trait MatchExpressionTypeInferenceExt {
    fn infer_type(&self, type_inference_context: &TypeInferenceContext, context: &str) -> Result<WorkflowType, WorkflowSemanticError>;
    ...
    fn validate_variant_coverage(
        &self,
        matched_inner_type: &WorkflowType,
        has_fallback_branch: bool,
        context: &str,
    ) -> Result<(), WorkflowSemanticError>;
}
...
trait ToolCallTypeInferenceExt {
    fn infer_type(&self, type_inference_context: &TypeInferenceContext, context: &str) -> Result<WorkflowType, WorkflowSemanticError>;
    fn validate_object_fields(
        &self,
        tool_name: &str,
        field_group_name: &str,
        fields: &[superwire_types::ast::ObjectField],
...
impl ToolCallTypeInferenceExt for ToolCall {
    fn infer_type(&self, type_inference_context: &TypeInferenceContext, context: &str) -> Result<WorkflowType, WorkflowSemanticError> {
...
trait ReferenceTypeInferenceExt {
...
impl ReferenceTypeInferenceExt for Reference {
    fn resolve_workflow_type_access_path(
        &self,
        root_type: &WorkflowType,
        access_start_index: usize,
...
mod tests {
    ...
    use superwire_types::ast::{SourcePosition, SourceSpan};
    ...
    fn tool_reference(tool_name: &str) -> Reference {
        Reference {
            ...
            accesses: vec![superwire_types::ast::ReferenceAccess::required(tool_name)],
            span: source_span(),
        }
    }

    fn object_field(field_name: &str, value: Expression) -> superwire_types::ast::ObjectField {
        superwire_types::ast::ObjectField {
