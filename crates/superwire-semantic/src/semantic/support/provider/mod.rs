...
use superwire_types::ast::{Declaration, Expression, ObjectField, ProviderDeclaration, Workflow};
...
trait ProviderExpressionEvaluationExt {
...
impl ProviderExpressionEvaluationExt for Expression {
    fn evaluate_as_provider_string(
        &self,
        provider_name: &str,
        property_name: &str,
