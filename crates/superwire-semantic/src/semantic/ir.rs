use crate::semantic::support::type_inference::{
...
mod tests {
    ...
    fn merges_model_and_model_usage_inference_by_precedence() {
        ...
        assert!(
            matches!(writer_agent.inference_fields[0].value, superwire_types::ast::Expression::NumberLiteral(ref value) if value == "0.8")
        );
    }
