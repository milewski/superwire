...
use superwire_core::dsl::{
    AgentExpressionPropertyName, AgentForLoopPattern, AgentProperty, Declaration, Expression, ObjectField, Reference, ReferenceKeyword,
...
use superwire_core::semantic::{ExecutionPlan, PlannedAgent, TypedToolIr, WorkflowExecutionGraph, WorkflowSemanticError};
...
impl WorkflowExecutor {
    ...
    fn planned_agent_available_mcp_calls(
        &self,
    ...
    fn validate_startup_mcp_tool_calls(
        &self,
        evaluation_context: &EvaluationContext,
        event_sender: Option<&mpsc::Sender<ExecutorEvent>>,
...
trait ExpressionMcpExecutionPlanExt {
